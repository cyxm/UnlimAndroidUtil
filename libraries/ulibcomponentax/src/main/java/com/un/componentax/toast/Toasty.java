package com.un.componentax.toast;
...
public class Toasty {
	...
	public static Toast custom(@NonNull Context context,
		...
		Drawable drawableFrame = ToastyUtils.getDrawable(context, R.drawable.shape_round);
		//		Shape shape = new RoundRectShape(new float[]{10, 10, 10, 10, 10, 10, 10, 10}, null, null);
		...
		//		else
		//		drawableFrame = ToastyUtils.getDrawable(context, R.drawable.shape_round);
		...
		AppCompatTextView vText = toastLayout.findViewById(R.id.vText);
		vText.setText(message);
		vText.setTextColor(textColor);
		//		toastTextView.setTypeface(currentTypeface);
		vText.setTextSize(TypedValue.COMPLEX_UNIT_SP, textSize);
